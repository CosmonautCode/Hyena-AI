    ...
    def load_agents(self):
        ...
        try:
            ...
            if instances:
                ...
                # Update TUI with correct model name  
                try:
                    from app.llm.engine import MODEL_PATH
                    model_name = MODEL_PATH.stem.split('.')[0]  # Extract "Qwen3.5-9B" from filename
                    self.tui.banner.model = model_name
                except Exception:
